...
class Block():
    ...
    def get_textures(self):
        return [self.texture_top, self.texture_bottom, self.texture_left, self.texture_right, self.texture_front, self.texture_back] #format: top, bottom, left, right, front, back
...
grass = Block(4, ['textures/block/grass_top.png','textures/block/dirt.png']+['textures/block/grass_block_side.png']*4, colors=[grass_top_color, None, None, None, None, None])
